    ...
    <div>
      <ol className="flex flex-col space-y-4 text-base font-semibold">
        <li className="flex items-center space-x-4">
          ...
          <span className="leading-5">76 ~ 100</span>
        </li>
        <li className="flex items-center space-x-4">
          ...
          <span className="leading-5">51 ~ 75</span>
        </li>
        <li className="flex items-center space-x-4">
          ...
          <span className="leading-5">26 ~ 50</span>
        </li>
        <li className="flex items-center space-x-4">
          ...
          <span className="leading-5">1 ~ 25</span>
        </li>
      </ol>
    </div>
  );
...
export default TruestScoreInfo;
