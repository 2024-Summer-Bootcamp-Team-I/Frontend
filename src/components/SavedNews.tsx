...
const SavedNews = () => {
  return (
    <div className="flex flex-row bg-white rounded-[3.75rem] shadow-lg">
      <div className="w-[200px] h-[220px] ml-[1.25rem] mt-[1.25rem]">
        <img src={articleEx} alt="ArticleImage" className="h-[12.5rem] w-[12.5rem] rounded-[2.5rem]" />
      </div>
      <div className="w-[37rem] h-[10.5rem] rounded-[3.75rem] ">
        <p className="flex items-center pl-[2rem] pt-[2rem] text-[1.5rem] font-semibold">
        ...
        <div className="flex items-end justify-end m-1 text-[#505050]">
      ...
      <div className="w-[11.25rem] h-[15rem] flex items-center">
